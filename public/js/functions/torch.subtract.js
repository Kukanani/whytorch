...
sourceCode = `
  <code>ans = <a href="https://docs.pytorch.org/docs/stable/generated/torch.subtract.html">torch.subtract</a>(input, other)</code><br/>
  <code>ans = input - other</code> <span class="codeAnnotation">(equivalent)</span><br/>
  <code>ans = <a href="https://docs.pytorch.org/docs/stable/generated/torch.subt.html">torch.sub</a>(input, other)</code><span class="codeAnnotation">(equivalent)</span><br/>
`;
explanation = `
