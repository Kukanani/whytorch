...
sourceCode = `
  <code>ans = <a href="https://docs.pytorch.org/docs/stable/generated/torch.div.html">torch.div</a>(input, other)</code><br/>
  <code>ans = input / other</code> <span class="codeAnnotation">(equivalent)</span><br/>
  <code>ans = <a href="https://docs.pytorch.org/docs/stable/generated/torch.divide.html">torch.divide</a>(input, other)</code><span class="codeAnnotation">(equivalent)</span><br/>
`;
explanation = `
  <div class="explanation">
  <p><code>div</code> performs element-wise division of two tensors.</p>
