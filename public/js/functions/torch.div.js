...
sourceCode = `
  <code>ans = <a href="https://docs.pytorch.org/docs/stable/generated/torch.div.html">torch.div</a>(A, B)</code><br/>
  <code>ans = A / B</code> <span class="codeAnnotation">(equivalent)</span><br/>
  <code>ans = <a href="https://docs.pytorch.org/docs/stable/generated/torch.divide.html">torch.divide</a>(A, B)</code><span class="codeAnnotation">(equivalent)</span><br/>
`;
explanation = `
