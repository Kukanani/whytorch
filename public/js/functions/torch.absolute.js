...
sourceCode = `
  <code>ans = <a href="https://pytorch.org/docs/stable/generated/torch.absolute.html">torch.absolute</a>(input)</code><br/>
  <code>ans = <a href="https://pytorch.org/docs/stable/generated/torch.abs.html">torch.abs</a>(input)</code> <span class="codeAnnotation">(equivalent)</span><br/>
`;
explanation = `
  <div class="explanation">
  <p><code>absolute</code> calculates the element-wise absolute value of the input tensor.</p>
  </div>
`;
var fxnArgs = {};
