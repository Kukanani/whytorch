...
const sourceCode = `
  <code>ans = <a href="https://docs.pytorch.org/docs/stable/generated/torch.add.html">torch.add</a>(input, other)</code><br/>
...
const explanation = `
  ...
  sum of the items at the same indices in <code>input</code> and <code>other</code>.</p>
  </div>
`;
