...
sourceCode = `
  <code>ans = <a href="https://docs.pytorch.org/docs/stable/generated/torch.multiply.html">torch.multiply</a>(input, other)</code><br/>
  <code>ans = input * other</code> <span class="codeAnnotation">(equivalent)</span><br/>
  <code>ans = <a href="https://docs.pytorch.org/docs/stable/generated/torch.mul.html">torch.mul</a>(input, other)</code><span class="codeAnnotation">(equivalent)</span><br/>
`;
explanation = `
  <div class="explanation">
  <p><code>multiply</code> performs element-wise multiplication of two tensors.</p>
  <p>The item in the <code>i</code>th row and <code>j</code>th column of <code>ans</code> is the
  item at the <code>i</code>th row and <code>j</code>th column of <code>input</code> multiplied by
