...
sourceCode = `
  <code>ans = <a href="https://docs.pytorch.org/docs/stable/generated/torch.triu.html">torch.triu</a>(input)</code><br/>
`;
explanation = `
  <div class="explanation">
  <p><code>triu</code> returns the upper <a href="https://en.wikipedia.org/wiki/Triangular_matrix">triangular matrix</a> of the input.</p>
  </div>
`;
var fxnArgs = {};
