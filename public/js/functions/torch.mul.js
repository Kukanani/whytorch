...
sourceCode = `
  <code>ans = <a href="https://docs.pytorch.org/docs/stable/generated/torch.mul.html">torch.mul</a>(input, other)</code><br/>
  <code>ans = input * other</code> <span class="codeAnnotation">(equivalent)</span><br/>
  <code>ans = <a href="https://docs.pytorch.org/docs/stable/generated/torch.multiply.html">torch.multiply</a>(input, other)</code><span class="codeAnnotation">(equivalent)</span><br/>
`;
explanation = `
  <div class="explanation">
  <p><code>mul</code> performs element-wise multiplication of two tensors.</p>
