...
sourceCode = `
  <code>ans = <a href="https://docs.pytorch.org/docs/stable/generated/torch.mul.html">torch.mul</a>(A, B)</code><br/>
  <code>ans = A * B</code> <span class="codeAnnotation">(equivalent)</span><br/>
  <code>ans = <a href="https://docs.pytorch.org/docs/stable/generated/torch.multiply.html">torch.multiply</a>(A, B)</code><span class="codeAnnotation">(equivalent)</span><br/>
`;
explanation = `
