...
sourceCode = `
  <code>ans = <a href="https://docs.pytorch.org/docs/stable/generated/torch.sub.html">torch.sub</a>(A, B)</code><br/>
  <code>ans = A - B</code> <span class="codeAnnotation">(equivalent)</span><br/>
  <code>ans = <a href="https://docs.pytorch.org/docs/stable/generated/torch.subtract.html">torch.subtract</a>(A, B)</code><span class="codeAnnotation">(equivalent)</span><br/>
`;
explanation = `
